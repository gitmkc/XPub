		...
		foreach( $file as $this_file ) {
			if( $this_file != "." && $this_file != ".." ) {
				if( is_dir("$directory/$this_file") ) {
					// Directory
					$php_file_tree .= "<li class=\"pft-directory\" id=\"dir$this_file\" onClick=\"selectEpubDir(this);\" ><a href=\"#\">" . htmlspecialchars($this_file) . "</a><input type='hidden' value=\"$this_file\" id='selectDirVal' name='selectDir'/>";
